(function($) {
	...
	$.fn.factoryBootstrap000_dropdownAndColors = function(option) {
		// call an method
	...
	$.fn.factoryBootstrap000_dropdownAndColors.Constructor = dropdownAndColors;

	$(function() {
		$(".factory-bootstrap-000 .factory-dropdown-and-colors").factoryBootstrap000_dropdownAndColors();
	});
