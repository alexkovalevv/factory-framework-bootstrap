( function($) {
	...
	$.fn.factoryBootstrap000_checkboxControl = function(option) {
	...
	$.fn.factoryBootstrap000_checkboxControl.Constructor = CheckboxControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-000 .factory-checkbox.factory-buttons-way").factoryBootstrap000_checkboxControl();
	});
