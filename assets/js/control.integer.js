( function( $ ){
    ...
    $.fn.factoryBootstrap000_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap000_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-000 .factory-integer").factoryBootstrap000_integerControl();
    });
