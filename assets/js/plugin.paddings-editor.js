( function( $ ){
    ...
    $.fn.factoryBootstrap000_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap000_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-000 .factory-paddings-editor").factoryBootstrap000_paddingsEditor();
    });
