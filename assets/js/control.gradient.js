( function( $ ){
    ...
    $.fn.factoryBootstrap000_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap000_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-000 .factory-gradient").factoryBootstrap000_gradientControl();
    });
