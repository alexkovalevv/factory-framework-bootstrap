( function( $ ){
    ...
    $.fn.factoryBootstrap000_listControl = function (option) {
    ...
    $.fn.factoryBootstrap000_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-000 .factory-list").factoryBootstrap000_listControl();
    });
