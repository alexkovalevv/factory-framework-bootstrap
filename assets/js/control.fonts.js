...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap000.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap000_fontControl", $.factoryBootstrap000.fontControl );
        $(".factory-bootstrap-000 .factory-font").factoryBootstrap000_fontControl({});
    });
