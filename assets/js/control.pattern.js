...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap000.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap000_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap000_patternControl", $.factoryBootstrap000.patternControl );
        $(".factory-bootstrap-000 .factory-pattern").factoryBootstrap000_patternControl({});
    });
