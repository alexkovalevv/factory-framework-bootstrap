...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap000.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap000_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap000_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap000_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap000_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap000_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap000_colorControl", $.factoryBootstrap000.colorControl );
        $(".factory-bootstrap-000 .factory-color").factoryBootstrap000_colorControl({});
    });
