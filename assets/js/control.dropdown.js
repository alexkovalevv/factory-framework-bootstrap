( function($) {
	...
	$.fn.factoryBootstrap000_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap000_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-000 .factory-dropdown").factoryBootstrap000_dropdownControl();
	});
